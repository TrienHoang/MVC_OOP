                    ...
                    <div class="container">
                        <form action="/admin/products/update/{{ $product['p_id'] }}" method="POST"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <textarea class="form-control" id="content" name="content">
                                        {!! $product['p_content'] !!}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="img_thumbnail" class="col-4 col-form-label">Img_thumbnail</label>
                                <div class="col-8">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <input type="checkbox" class="form-checkbox" @checked($product['p_is_active'])  value="1" name="is_active"
                                        id="is_active" />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <input type="checkbox" class="form-checkbox" @checked($product['p_is_sale']) value="1" name="is_sale"
                                        id="is_sale" />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <input type="checkbox" class="form-checkbox" @checked($product['p_is_show_home']) value="1" name="is_show_home"
                                        id="is_show_home" />
                                </div>
                            </div>
